...
from ragpilot.retrieval.graph import DEFAULT_LIMIT, DEFAULT_MAX_DEPTH
from ragpilot.retrieval.graph import references as graph_references
...
def references(
    ...
    with AppContext.bootstrap() as ctx:
        matches, edges = graph_references(ctx, name, max_depth=max_depth, limit=limit)
