...
def test_partial_indexing_failure_is_reported_and_does_not_crash(
    ...
    source_dir.mkdir()
    (source_dir / "good1.py").write_text("print('ok')")
    (source_dir / "good2.py").write_text("print('ok too')")
    (source_dir / "poison.py").write_text("print('boom')")
